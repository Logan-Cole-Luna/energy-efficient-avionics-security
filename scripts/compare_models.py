#!/usr/bin/env python3
"""
compare_models.py — Benchmark all five candidate IDS models on UNSW-NB15 and NSL-KDD.

Trains and evaluates:
  TinyDecisionTree, TinyXGBoost, MicroXGBoost, LightRandomForest, CompactExtraTrees

Outputs:
  results/model_selection_unsw.json   — per-model metrics on UNSW-NB15
  results/model_selection_nsl.json    — per-model metrics on NSL-KDD
  results/model_comparison.json       — combined table used in the paper
...
if __name__ == '__main__':
    ...
    with open(RESULTS / 'model_selection_unsw.json', 'w') as f:
    ...
    for ds_name, results in [('UNSW-NB15', unsw_results), ('NSL-KDD', nsl_results)]:
        ...
        print()
    print("="*90)
    print(f"\nResults saved to {RESULTS}/model_selection_unsw.json, model_selection_nsl.json, model_comparison.json")
