...
Remove the mandatory boot delay at power-on.
Starting from this version, the device boots the normal firmware immediately, bypassing the multiple-second delay.
